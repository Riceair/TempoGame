...
public class HitObj : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 hit_position = GameObject.Find("HitPoint").transform.position;
        distance = Vector3.Distance(generate_position,hit_position);
        time = 2f;
    ...
    void Update()
    {
        transform.Translate(0,0,-Time.deltaTime*(distance/time));
    }
